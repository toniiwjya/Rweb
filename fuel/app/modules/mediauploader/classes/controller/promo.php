...
class Controller_Promo extends \Controller_Backend
{
	private $_module_url = 'backend/media-uploader/promo';
	private $_menu_key = 'media_uploader_promo';
	...
	public function before() {
		...
		$this->_data_template['meta_title'] = 'Media Uploader - Promo';
	...
	public function action_index() {
		...
		$this->_data_template['media_uploader_subtitle'] = 'Promo';
	...
	public function action_upload() {
		...
		$options = array(
			...
			'upload_dir' => DOCROOT.'media/promo/',
                        'upload_url' => \Uri::base().'media/promo/',
