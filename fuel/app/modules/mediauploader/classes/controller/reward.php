...
class Controller_Reward extends \Controller_Backend
{
	private $_module_url = 'backend/media-uploader/reward';
	private $_menu_key = 'media_uploader_reward';
	...
	public function before() {
		...
		$this->_data_template['meta_title'] = 'Media Uploader - Reward';
	...
	public function action_index() {
		...
		$this->_data_template['media_uploader_subtitle'] = 'Reward';
	...
	public function action_upload() {
		...
		$options = array(
			...
			'upload_dir' => DOCROOT.'media/reward/',
                        'upload_url' => \Uri::base().'media/reward/',
