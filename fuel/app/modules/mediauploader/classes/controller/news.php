...
{
	private $_module_url = 'backend/media-uploader/news';
	private $_menu_key = 'media_uploader_news';
	...
	public function before() {
		...
		$this->_data_template['meta_title'] = 'Media Uploader - News';
	...
	public function action_index() {
		...
		$this->_data_template['media_uploader_subtitle'] = 'News';
	...
	public function action_upload() {
		...
		$options = array(
			...
			'upload_dir' => DOCROOT.'media/news/',
                        'upload_url' => \Uri::base().'media/news/',
