...
class Controller_Homebanner extends \Controller_Backend
{
	private $_module_url = 'backend/media-uploader/homebanner';
	private $_menu_key = 'media_uploader_homebanner';
	...
	public function before() {
		...
		$this->_data_template['meta_title'] = 'Media Uploader - Home Banner';
	...
	public function action_index() {
		...
		$this->_data_template['media_uploader_subtitle'] = 'Home Banner';
	...
	public function action_upload() {
		...
		$options = array(
			...
			'upload_dir' => DOCROOT.'media/homebanner/',
                        'upload_url' => \Uri::base().'media/homebanner/',
