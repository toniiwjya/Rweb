...
class Twig_Fuel_Extension extends \Parser\Twig_Fuel_Extension
{
	...
	public function getFunctions()
	{
		return array(
			...
			// Custom function
			'horizontal_form_input'       => new Twig_Function_Function('Helper_Form::horizontal_form_input'),
			'helper_make_url'             => new Twig_Function_Function('Helper_Url::make_url'),
			'helper_is_external_link'     => new Twig_Function_Function('Helper_Url::is_external_link'),
			'http_referrer'               => new Twig_Function_Function('Input::referrer'),
            'str_truncate'                => new Twig_Function_Function('Str::truncate'),
			'file_exists'                 => new Twig_Function_Function('File::exists'),
		);
	}
